...
--synthesis_resources = 
 ...
 ENTITY  DEO_SALVA_mm_interconnect_0_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END DEO_SALVA_mm_interconnect_0_cmd_xbar_demux;

 ARCHITECTURE RTL OF DEO_SALVA_mm_interconnect_0_cmd_xbar_demux IS
 ...
 END RTL; --DEO_SALVA_mm_interconnect_0_cmd_xbar_demux
