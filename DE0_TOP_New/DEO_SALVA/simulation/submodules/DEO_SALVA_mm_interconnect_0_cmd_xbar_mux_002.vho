...
--synthesis_resources = 
 ...
 ENTITY  DEO_SALVA_mm_interconnect_0_cmd_xbar_mux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END DEO_SALVA_mm_interconnect_0_cmd_xbar_mux_002;

 ARCHITECTURE RTL OF DEO_SALVA_mm_interconnect_0_cmd_xbar_mux_002 IS
 ...
 END RTL; --DEO_SALVA_mm_interconnect_0_cmd_xbar_mux_002
